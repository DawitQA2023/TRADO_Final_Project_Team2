import allure
import pytest
from TRADO.Web.QA_WEB.Pages.contact_usQA_page import ContactUS_Page
from TRADO.Web.QA_WEB.Utils.utils_QA import Utils
from TRADO.Web.QA_WEB.Locators.locatorQA_Contact_Us import Locators_Contact_Us as path
...
class Test_Contact_us_Chrome1(Pre_Requirement_Login_Chrome):
    ...
    def test_display_Contact_us_PAGE(self):
        ...
        text = contact.Assert_text(path.CONTACT_TITLE)
    ...
    def test_Contact_us_Full_Information(self):
        ...
        text = contact.Assert_text(path.SUCCESS_TEXT)
    ...
    def test_send_with_out_filling_all_details(self):
        ...
        contact.Click_Send_Button()
        text = contact.Assert_text(path.ERROR_FIRST_NAME)
    ...
    def test_Contact_us_Without_LastName(self):
        ...
        contact.Insert_Content_Referral("Never give up any one")
        contact.Click_Send_Button()
        text = contact.Assert_text(path.ERROR_LAST_NAME)
        Utils(driver).assertion(text, "נא למלא שדה זה")
    ...
    def test_Contact_us_Without_Email(self):
        ...
        contact.Insert_Content_Referral("Never give up any one")
        contact.Click_Send_Button()
        text = contact.Assert_text(path.ERROR_EMAIL)
        Utils(driver).assertion(text, "נא למלא שדה זה")
    ...
    def test_Contact_us_Without_Phone_Number(self):
        ...
        contact.Insert_Content_Referral("Never give up any one")
        contact.Click_Send_Button()
        text = contact.Assert_text(path.ERROR_PHONE)
        Utils(driver).assertion(text, "נא למלא שדה זה")
    ...
    def test_Contact_us_Without_Content_Referral(self):
        ...
        contact.Insert_Content_Referral('')
        contact.Click_Send_Button()
        text = contact.Assert_text(path.ERROR_CONTACT_REFERRAL)
        Utils(driver).assertion(text, "נא למלא שדה זה")
    ...
    def test_Contact_us_Without_FirstName_and_LastName(self):
        ...
        text = contact.Assert_text(path.ERROR_FIRST_NAME)
        Utils(driver).assertion(text, "נא למלא שדה זה")
        text2 = contact.Assert_text(path.ERROR_LAST_NAME)
    ...
    def test_Contact_us_Without_FirstName_and_Email(self): #  ????????????????????????????????
        ...
        text = contact.Assert_text(path.ERROR_FIRST_NAME)
        Utils(driver).assertion(text, "נא למלא שדה זה")
        text2 = contact.Assert_text(path.ERROR_EMAIL)
        Utils(driver).assertion(text2, "נא למלא שדה זה")
    ...
    def test_Contact_us_Without_FirstName_LastName_and_Email(self): #  ????????????????????????????????
        ...
        text2 = contact.Assert_text(path.ERROR_LAST_NAME)
        Utils(driver).assertion(text2, "נא למלא שדה זה")
        text3 = contact.Assert_text(path.ERROR_EMAIL)
    ...
    def test_Contact_us_Without_FirstName_and_Phone_Number(self):
        ...
        text = contact.Assert_text(path.ERROR_FIRST_NAME)
        Utils(driver).assertion(text, "נא למלא שדה זה")
        text2 = contact.Assert_text(path.ERROR_PHONE)
        Utils(driver).assertion(text2, "נא למלא שדה זה")
    ...
    def test_Contact_us_Without_FirstName_LastName_Email_and_Phone_Number(self): #  ????????????????????????????????
        ...
        text3 = contact.Assert_text(path.ERROR_EMAIL)
        Utils(driver).assertion(text3, "נא למלא שדה זה")
        text4 = contact.Assert_text(path.ERROR_PHONE)
    ...
    def test_Contact_us_without_FirstName_and_contentReferral(self):
        ...
        text = contact.Assert_text(path.ERROR_FIRST_NAME)
        Utils(driver).assertion(text, "נא למלא שדה זה")
        text2 = contact.Assert_text(path.ERROR_CONTACT_REFERRAL)
        Utils(driver).assertion(text2, "נא למלא שדה זה")
    ...
    def test_Contact_us_without_Information(self):
        ...
        text = contact.Assert_text(path.ERROR_FIRST_NAME)
        Utils(driver).assertion(text, "נא למלא שדה זה")
        text1 = contact.Assert_text(path.ERROR_LAST_NAME)
        Utils(driver).assertion(text1, "נא למלא שדה זה")
        text3 = contact.Assert_text(path.ERROR_EMAIL)
        Utils(driver).assertion(text3, "נא למלא שדה זה")
        text4 = contact.Assert_text(path.ERROR_PHONE)
        Utils(driver).assertion(text4, "נא למלא שדה זה")
        text5 = contact.Assert_text(path.ERROR_CONTACT_REFERRAL)
...
class Test_Contact_us_Chrome2(Pre_Requirement_Login_Chrome):
    ...
    @allure.severity(allure.severity_level.NORMAL)
    def test_display_Contact_us_PAGE_with_out_login2(self):
        driver = self.driver
        contact = ContactUS_Page(driver)
        contact.Click_Contact_Button()
        text = contact.Assert_text(path.CONTACT_TITLE)
    ...
    @allure.description('Check contact us using full information ')
    @allure.severity(allure.severity_level.NORMAL)
    def test_Contact_us_Full_Information_with_out_login2(self):
        driver = self.driver
        contact = ContactUS_Page(driver)
        contact.Click_Contact_Button()
        contact.Insert_FirstName("wesagn")
...
class Test_Contact_Us_GUI(Pre_Requirement_Login_Chrome):
    @pytest.mark.sanity
    ...
    def test_Home_UI_Using_Home(self):
        driver = self.driver
        Contact_Us = ContactUS_Page(driver)
        Contact_Us.Click_Contact_Button()
        font_size = Contact_Us.Check_font_size(path.CONTACTUS_CSS)
        assert font_size == "16px"
        font_weight = Contact_Us.Check_font_weight(path.CONTACTUS_CSS)
        assert font_weight == "400"
        text_align = Contact_Us.Check_text_align(path.CONTACTUS_CSS)
