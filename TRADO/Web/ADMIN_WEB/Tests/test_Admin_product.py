...
from TRADO.Web.ADMIN_WEB.Pages.productAdmin_page import Product_Page
...
class Test_product_Chrome1(Pre_Requirement_Login_Chrome):
    @pytest.mark.sanity
    ...
    def test_with_barcodeAndName_fields(self):
        ...
        pro.click_next_product_buttons()
        text = pro.Assert_text(Locators_Admin.ERROR_PRICE)
    ...
    def test_with_priceAndName_fields(self, Valid_Login_to_Admin_homePage_With_Chrome_Valid_data_and_Trado_store):
        ...
        text = pro.Assert_text(Locators_Admin.ERROR_BARCODE)
    ...
    def test_with_priceAndbarcode_fields(self):
        ...
        text = pro.Assert_text(Locators_Admin.ERROR_NAME)
        Utils(driver).assertion("נא למלא שדה זהxxx", text)
    ...
    def test_valid_input_required_fields(self):
        ...
        text = pro.Assert_text(Locators_Admin.ERROR_FIRST_PAGE)
    ...
    def test_valid_input_pro_info_required_fields(self):
        ...
        text = production.Assert_text(Locators_Admin.ERROR_PRODUCT_INFO)
        # text = production.Assert_product_info_page()
        Utils(driver).assertion("מינימום קרטונים להזמנה", text)

    @pytest.mark.sanity
    @allure.description('Insert data for only storID required all field box with null SectionId ')
    @allure.severity(allure.severity_level.NORMAL)
    def test_only_storeID_required_fields(self):
        ...
        production.select_store_from_given()
        production.click_next_productInfo_buttons()
        text = production.Assert_text(Locators_Admin.ERROR_SECTION_ID)
    ...
    def test_with_null_required_fields(self):
        ...
        production.click_next_product_buttons()
        production.click_next_productInfo_buttons()
        text = production.Assert_text(Locators_Admin.ERROR_NULL)
    ...
    def test_valid_input_unit_required_fields(self):
        ...
        text = production.Assert_text(Locators_Admin.ERROR_UNIT_PAGE)
    ...
    @allure.severity(allure.severity_level.NORMAL)
    def test_with_amount_and_minus_order_required_fields(self):
        driver = self.driver
        production = Product_Page(driver)
        production.click_on_product_sidebar()
        production.click_kebab_buttons()
        ...
        production.enter_minOrder_fields(2)
        production.click_next_productUnit_buttons()
        text = production.Assert_text(Locators_Admin.ERROR_UNITINCARTON)
        # text = production.Assert_unitIncarton()
        Utils(driver).assertion("מינימום קרטונים להזמנה", text)

    @pytest.mark.sanity
    @allure.description(
        'Enter a data onliy "AMOUNT AND UNIT IN CARTON " for requierd fields in product unit paga if ''any..')
    @allure.severity(allure.severity_level.NORMAL)
    def test_with_amount_and_unit_required_fields(self):
        ...
        text = production.Assert_text(Locators_Admin.ERROR_MIN_ORDER)
        Utils(driver).assertion("מינימום קרטונים להזמנה", text)
    ...
    def test_with_minOrder_and_unit_required_fields(self):
        ...
        text = production.Assert_text(Locators_Admin.ERROR_AMOUNT_IN_CARTON)
        Utils(driver).assertion("מינימום קרטונים להזמנה", text)
    ...
    def test_valid_input_delivery_required_fields(self):
        ...
        text = production.Assert_text(Locators_Admin.ERROR_DELIVERY)
    ...
    def test_search_products_too(self):
        ...
        text = pro.Assert_text(Locators_Admin.ERROR_SEARCH_VALID_PRODUCT)
    ...
    def test_languageUS_change_too(self):
        ...
        pro = Product_Page(driver)
        pro.click_on_product_sidebar()
        pro.click_languageUS_buttons()
        text = pro.Assert_text(Locators_Admin.ERROR_LANGUAGE)
    ...
    def test_page5_products_too(self):
        ...
        # text = pro.Assert_text(Locators_Admin.ERROR_BACKTITLE)
    ...
    def test_import_products_too(self):
        ...
        text = pro.Assert_text(Locators_Admin.ERROR_IMPORT_TITLE)
